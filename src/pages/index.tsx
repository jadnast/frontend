        ...
        <>
            ...
            <div id="hero" className="w-full h-[962px] justify-center items-center inline-flex">
                <div className="grow shrink basis-0 self-stretch flex-col justify-center items-center gap-3.5 inline-flex">
                  <div className="self-stretch h-6 text-center text-neutral-400 text-lg font-normal leading-snug">ДЕСЯТКИ ТЫСЯЧ АНИМЕ В ОДНОМ МЕСТЕ</div>
                  <div className="self-stretch h-32 flex-col justify-start items-center gap-1 flex">
                    <div className="self-stretch text-center text-white text-4xl font-bold uppercase tracking-widest">Привнесите аниме</div>
                ...
                <div className="hero_ch1" style={{ position: 'absolute', left: '-1%' }}>
                    <img src="/images/main/ch1.png" alt=""/>
                </div>

                <div className="hero_ch2" style={{ position: 'absolute', right: '-1%' }}>
